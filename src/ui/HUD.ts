...
export class HUD {
    ...
    `;
        ...
        this.drillBtn = document.getElementById(
            "btn-drill",
        ) as HTMLButtonElement;
        this.addDroneBtn = document.getElementById(
            "btn-add-drone",
        ) as HTMLButtonElement;
        this.capacityBtn = document.getElementById(
            "btn-capacity",
        ) as HTMLButtonElement;
        this.upgradeBtn = document.getElementById(
            "btn-upgrade",
        ) as HTMLButtonElement;
        ...
        document
            .getElementById("btn-overdrive-close")!
            .addEventListener("click", () => this.hideOverdrive());
        document
            .getElementById("btn-overdrive-tab")!
            .addEventListener("click", () => this.toggleOverdrive());
